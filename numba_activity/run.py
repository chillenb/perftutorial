...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=2000,
        help="Number of points in the system",
    )
    parser.add_argument(
        "-r", "--repeats", type=int, default=4, help="Number of repeats for timing"
    )
    ...
    elapsed_time = timeit.timeit(
        "total_energy(coords)", globals=globals(), number=args.repeats
    )
